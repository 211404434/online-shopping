	...
	<c:choose>
		<c:when test="${not empty cartLines}">
			<table id="cart" class="table table-hover table-condensed">
				...
				<tfoot>
					<tr class="visible-xs">
						<td class="text-center"><strong>Total R ${userModel.cart.grandTotal}</strong></td>
					</tr>
					<tr>
						...
						<td class="hidden-xs text-center"><strong>Total R ${userModel.cart.grandTotal}/-</strong></td>
