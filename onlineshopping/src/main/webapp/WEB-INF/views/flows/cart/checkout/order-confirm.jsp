...
<title>Pick N Pay Online Shopping - Membership</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
           ...
           <div class="navbar-header">
               <a class="navbar-brand" href="${contextRoot}/home"> Pick N Pay Online Shopping</a>
           </div>
		</div>
	</nav>
		    						...
		    						<tbody>
		    							...
		    							<c:forEach items="${orderDetail.orderItems}" var="orderItem">
			    							<tr>
			    								...
			    								<td class="text-center">R ${orderItem.buyingPrice}</td>
			    								<td class="text-center">${orderItem.productCount}</td>
			    								<td class="text-right">R ${orderItem.total}</td>
			    							</tr>
		    							</c:forEach>
		    						</tbody>
		    					</table>
