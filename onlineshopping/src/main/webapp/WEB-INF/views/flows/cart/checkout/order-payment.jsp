	...
	<div class="row">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div>
							...
							<h5>Buying Price - R ${cartLine.buyingPrice}/-</h5>							
						</div>						
						<hr/>
						<div class="text-right">
							<h3>Grand Total - R ${cartLine.total}/-</h3>
						</div>						
					</div>
					</c:forEach>
				</div>
			...
			<div class="col-md-6">
	            ...
	            <ul class="nav nav-pills nav-stacked">
	                <li class="active"><a href="#"><span class="badge pull-right"> R ${checkoutModel.checkoutTotal}/-</span> Final Payment</a></li>
	            </ul>
	            <br/>
